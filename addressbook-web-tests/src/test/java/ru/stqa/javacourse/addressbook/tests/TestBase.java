...
import ru.stqa.javacourse.addressbook.tests.groups.GroupCreationTests;
  ...
  public void verifyContactListInUI() {
    if (Boolean.getBoolean("verifyUI")) {
      ...
      assertThat(uiContacts, equalTo(dbContacts.stream().map((c) -> new ContactData()
              .withId(c.getId()).withFirstName(c.getFirstname()).withLastName(c.getLastname()).withAddress(c.getAddress()))
